	...
	$(function() {
		...
		function initSlider(itemIndex){
			...
			if(imggroupId=="allphotos"){
				...
				var $imgItemArr = container.find("a[data-imggroup='"+imggroupId+"']");
			}
			...
			gallery
				...
				onPrevNextEvent: function(isNext) {
					...
					/*if ($('.img-item.current-item').attr('data-imggroup')=="article"){
						$(".related-bar").stop(true,true).fadeIn();
					}else{
						$(".related-bar").stop(true,true).fadeOut();
					}*/
				}
			});
		...
		window.addEventListener('popstate', function(event) {
		  ...
		  imgPushUrl = "chevrolet/camaro/2012/photos/exterior/hr-2/t3-12-8/";
		  $('.item-wrap a[data-pushurl*="'+imgPushUrl+'"]').click();
		});
