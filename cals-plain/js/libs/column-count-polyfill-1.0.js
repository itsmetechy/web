		...
		_create: function() {
			...
			if (liCount > 0) {
				...
				for (i = 0; i < colCount; i++) {
					//for IE7 and IE8 - reduce last column's width by 1 - wrapper div gets moved to new line
					if (i == colCount - 1 && $.browser.msie && ($.browser.version == 7 || $.browser.version == 8)) {
						colWidth--;
					}
					var $col = $('<div style="float:left;width:' + colWidth + colWidthUnit + ';"></div>');
					var $ul = $('<ul></ul>');
