...
$filename = "images/".$name."_". $_FILES['file']['name'];
...
<?php echo $change; ?>  </div>
  ...
  <div id="container" >
   ...
   <div id="con">
        ...
        <table width="502" cellpadding="0" cellspacing="0" id="main">
          <tbody>
            <tr>
			  ...
			  <div id="posts">
			  &nbsp;&nbsp;&nbsp;&nbsp;
                        <div class="cropBox" style="height:300px; width:400px; position:absolute; background:#ccc; z-index:1; display:none;">
        <img src=""/>
        </div>
                  <div id="cropbox"><img src="<?php echo $filename; ?>" /></div>  &nbsp;&nbsp;&nbsp;&nbsp;
                  <!--<img src="<?php echo $filename1; ?>"  />-->
			    <form method="post" action="upload.php" enctype="multipart/form-data" name="form1">
		...
		<tr><Td></Td><Td valign="top" height="35px"><input style="display:none;" type="submit" id="mybut" value="Upload" name="Submit"/></Td></tr>
        <tr>
          <td width="200">&nbsp;</td>
          <td width="200"><table width="200" border="0" cellspacing="0" cellpadding="0">
			...
			<input type="submit" value="Crop Image" onclick="return checkCoords();" />
